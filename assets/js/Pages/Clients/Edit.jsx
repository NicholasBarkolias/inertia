    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 p-8">
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            <Link href={`/clients/${client.id}`} className="text-orange-600 hover:text-orange-700 mb-4 inline-block">
              ← Back to Client
            </Link>
            <h1 className="text-4xl font-bold text-slate-800 mb-2">Edit Client</h1>
